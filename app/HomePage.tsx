...
export default function HomePage() {
  ...
  // Handle pesan error dari QR scanner
  ...
  const handleJoin = async () => {
    ...
    // Check: Validasi profile sudah ter-fetch dan valid
    ...
    // Check: Validasi fullname/username sudah ter-fetch
      ...
      <div className="relative z-10 flex flex-col items-center justify-center h-full w-full">
        <div className="text-center relative pb-5 sm:pt-3 pt-16 space-y-3 flex flex-col items-center">
          ...
          <Image
            ...
            className="w-[250px] sm:w-[300px] md:w-[350px] lg:w-[400px] h-auto mx-auto drop-shadow-xl"
          />
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 sm:gap-6 max-w-4xl w-full px-4 grid-rows-none sm:grid-flow-row grid-flow-dense max-sm:[grid-template-areas:'join'_'host']">
          ...
          >
            <Card className="bg-[#1a0a2a]/70 border-[#00ffff]/70 hover:border-[#00ffff] transition-all duration-300 sm:h-full shadow-[0_0_15px_rgba(255,107,255,0.3)] pixel-card justify-between">
