      ...
      countdownIntervalRef.current = setInterval(() => {
        ...
        if (remaining <= 0) {
          ...
          setTimeout(async () => {
            ...
            else router.push(`/host/${roomCode}/monitor`);
          }, 500);
        }
      }, 100);
    },
      ...
      <div className="absolute inset-0 overflow-y-auto z-10">
        ...
        <div className="relative max-w-8xl mx-auto p-4 sm:p-6 md:p-8 pt-0">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-5 gap-2 items-start">
            <Card className="bg-[#1a0a2a]/60 border-2 sm:border-3 border-[#ff6bff]/50 pixel-card glow-pink-subtle p-2 sm:p-4 lg:col-span-2 order-1 lg:order-1 self-start lg:sticky lg:top-4">
