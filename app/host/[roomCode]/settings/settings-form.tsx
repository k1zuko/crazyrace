...
// // import { mysupa, supabase } from "@/lib/supabase" // Direct access removed
...
// import { updateGameSettings, deleteGameSession } from "@/app/actions/game-settings"
...
//             router.push('/host');
//         }
//     }, [initialData.error, initialData.session, router]);
...
//     // Set default question count after mount
//     useEffect(() => {
//         if (!quiz) return;
//         const totalQuestions = quiz.questions?.length || 0;
//         if (totalQuestions > 0) {
...
//     // Only return null for missing initial data, not for saving (global loading handles saving state)
//     if (!quizDetail || !sessData) return <LoadingRetro />;
