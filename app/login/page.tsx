...
export default function LoginPage() {
  ...
  // URL Dinamis untuk halaman register.
  const registerUrl =
  ...
  return (
    <div className="min-h-screen bg-[#1a0a2a] relative overflow-hidden">
      ...
      {/* Logo CrazyRace Desktop */}
      <div className="absolute top-4 left-4 hidden md:block">
        <div className="hidden md:block">
          <Image src="/crazyrace-logo.webp" alt="Crazy Race" width={270} height={50} sizes="270px" style={{ imageRendering: 'auto' }} className="h-auto drop-shadow-xl" priority />
        </div>
      </div>

      <div className="relative z-10 flex flex-col justify-center items-center md:min-h-screen px-4 sm:px-6">
        {/* Logo CrazyRace Mobile */}
