      ...
      <div className="relative z-10">
        ...
        <div className="w-full pb-0 flex items-center justify-between">
          ...
          <div className="flex items-center gap-4">
            <div className="hidden md:block">
              <Image src="/crazyrace-logo.webp" alt="Crazy Race" width={270} height={50} sizes="270px" style={{ imageRendering: 'auto' }} className="h-auto drop-shadow-xl" onClick={() => setShowExitDialog(true)} />
            </div>
          </div>
        ...
        <div className="max-w-7xl mx-auto pt-0 px-4">
          <div className="text-center m-3">
            <h1 className="sm:max-w-none text-2xl sm:text-3xl md:text-4xl  font-bold text-[#00ffff] pixel-text glow-cyan mb-4 tracking-wider">
              {t('lobby.title')}
            </h1>
          </div>
